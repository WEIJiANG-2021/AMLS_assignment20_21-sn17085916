...
from B1.lenet import LeNet
from B2.dataset import CELEBAData
...
class Face_shape():
    ...
    def test(self, test_dir="Datasets/cartoon_set_test/"):
        ...
        print("Face_shape识别率为%.2f" % (acc))

    @ torch.enable_grad()
    def train(self, train_dir="Datasets/cartoon_set/", save_dir='B1/model'):
...
if __name__ == "__main__":
    ...
    face_shape.train("../Datasets/cartoon_set/")
