...
from A1.lenet import LeNet
from A1.dataset import CELEBAData
...
class Gender():
    ...
    def test(self, test_dir="Datasets/celeba_test/"):
        ...
        print("Gender识别率为%.2f" % (acc))

    @ torch.enable_grad()
    def train(self, train_dir='Datasets/celeba/', save_dir='A1/model'):
