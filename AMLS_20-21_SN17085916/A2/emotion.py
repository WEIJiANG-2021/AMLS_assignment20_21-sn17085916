...
from A2.lenet import LeNet
from A2.dataset import CELEBAData
...
class Emotion():
    ...
    @ torch.no_grad()
    def test(self, test_dir="Datasets/celeba_test/"):
        self.net.eval()
        # test_dir = "Datasets/celeba_test/"
        net_path = 'A2/model/model.pth'
        ...
        print("Emotion识别率为%.2f" % (acc))

    @ torch.enable_grad()
    def train(self, train_dir='Datasets/celeba/', save_dir='A2/model'):
